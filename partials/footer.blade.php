...
<footer>
	<div class="container">
				...
				<div class="client">
					...
					@if(count(list_payments()) > 0)
						@foreach(list_payments() as $pay)
							...
							<img src="{{url('img/bitcoin.png')}}" alt="bitcoin" class="img-responsive logo-bank" title="Bitcoin" />
							@endif
						@endforeach
					@endif
		...
		<div class="copy text-center">
			{{ Theme::place('title') }} Copyright {{date('Y')}} &copy; - Powered by <a target="_blank" href="http://jarvis-store.com">Jarvis Store</a>
		</div>
	</div>
</footer>
{{pluginPowerup()}} 