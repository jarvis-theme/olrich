                        ...
                        <div class="catchy-subscribe" id="mc_embed_signup">
                            ...
                            <form action="{{@$mailing->action}}" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form newsletter" class="form-inline validate" target="_blank" role="form" novalidate>
                                <div class="form-group">
                                    <input type="email" placeholder="Masukkan email anda" name="EMAIL" class="form-control required email" id="newsletter mce-EMAIL" {{ @$mailing->action==''?'disabled="disabled" style=cursor:default':'' }}>
                                </div>
                        ...
                        <div class="report">
                            <div class="report-bor">
                                ...
                                <div class="row center">
                                    ...
                                    @endif
                                    @if($sosial->ig)
                                        <a target="_blank" class="instagram" href="{{URL::to($sosial->ig)}}" title="Instagram"><i class="icon-instagram"></i></a>
                                    @endif
                                    @if($sosial->pt)
